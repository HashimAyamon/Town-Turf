...
function ScheduleTurf(props) {
  ...
  let toggleradio = (obj) => {
    if (obj.status === "A") {
      props.setschedule((previousState) => {
        return {
          ...previousState,
          turftiming: props.schedule.turftiming.map((item) => {
            if (item === obj) {
  ...
  let schedulevalidations = () => {
    if (
      props.schedule.pricewithlight === "" ||
      props.schedule.pricewithoutlight === "" ||
      props.schedule.startdate === "yyyy-mm-dd" ||
      props.schedule.enddate === "yyyy-mm-dd"
    ) {
      return false;
    }
  ...
  let addpriceschedule = () => {
    for (var i = 0; i < props.schedule.turftiming.length; i++) {
      if (
        props.schedule.turftiming[i].time >=
          props.schedule.starttimewithoutlight &&
        props.schedule.turftiming[i].time <= props.schedule.endtimewithoutlight
      ) {
        ...
        <div>
          <div className="form-group">
            ...
            <input
              ...
              id="tpwol"
              value={props.schedule.pricewithoutlight}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
              id="tpwl"
              value={props.schedule.pricewithlight}
          ...
          <div className="form-group form-inline">
            ...
            <div className="form-group" htmlFor="enddate">
              <input
                ...
                className="form-control"
                id="enddate"
                value={props.schedule.enddate}
                onChange={enddatechange}
                disabled={props.schedule.startdate === "yyyy-mm-dd"}
              />
            </div>
          </div>
